      ...
      function t(){
        ...
        n.addEventListener("click", function(){
          ...
          if(e){
            ...
            e.setAttribute("sandbox", "allow-scripts allow-same-origin allow-forms allow-top-navigation"); // 別タブオープン制御
            ...
            e.onload = function(){
              try {
                const links = e.contentDocument.querySelectorAll('a[target="_blank"]');
                links.forEach(link => {
                  link.target = "_self";
                ...
                console.warn("リンクのターゲット変更に失敗しました（異なるオリジンの可能性あり）:", err);
              }
            };
